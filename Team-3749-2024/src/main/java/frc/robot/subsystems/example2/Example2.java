...
import frc.robot.subsystems.example2.ExampleIO.ExampleData;
...
public class Example2 extends SubsystemBase implements CurrentBudgettedSubsystem {
    ...
    private ShuffleData<Double> voltageLog = new ShuffleData<Double>("ex 2", "voltage", 0.0);
    private ShuffleData<Double> currentLog = new ShuffleData<Double>("ex 2", "current", 0.0);
    private ShuffleData<Double> tempLog = new ShuffleData<Double>("ex 2", "temp", 0.0);
